...
def gifters_cities_dict():
	...
	'admin@rimonlaw.com' : ['Lake Tahoe', 'Las Vegas', 'Los Angeles', 'Orange County', 'Palo Alto', 'Menlo Park', 'Silicon Valley', 'Portland', 'Sacramento', 'San Diego', 'San Francisco', 'Seattle', 'Boise', 'Idaho'],
