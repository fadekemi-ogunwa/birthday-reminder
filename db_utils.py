...
def gifters_cities_dict():
	return {'kynyziah.shaw@rimonlaw.com' : ['Bedminster', 'Boston', 'Jerusalem', 'Miami', 'New York', 'Newark', 'Northern Virginia', 'NYC', 'Orlando', 'Research Triangle', 'Tel Aviv', 'Washington, D.C.', 'DC','Washington', 'Chicago', 'Dallas', 'Minneapolis', 'Kansas', 'Kansas City'],
